...
public class Register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editUsername = findViewById(R.id.editTextTextR1);
        editEmail = findViewById(R.id.editTextTextR2);
        editPassword = findViewById(R.id.editTextTextR3);
        editConfirm = findViewById(R.id.editTextTextR4);
        button = findViewById(R.id.buttonR1);
        editLog = findViewById(R.id.textViewR22);
