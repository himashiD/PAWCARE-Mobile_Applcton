...
public class CareGiverRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_care_giver_register);

        editUsername = findViewById(R.id.editTextTextCR1);
        editEmail = findViewById(R.id.editTextTextCR2);
        editPassword = findViewById(R.id.editTextTextCR3);
        editConfirm = findViewById(R.id.editTextTextCR4);
        button = findViewById(R.id.buttonCR1);
        editLog = findViewById(R.id.textViewCR22);
            ...
            public void onClick(View v) {
                ...
                if (username.length() == 0 || email.length() == 0 || password.length() == 0 || confirm.length() == 0) {
                    ...
                    if (password.compareTo(confirm) == 0) {
                        if(isValid(password)){
                            db.registerCaregiver(username,email,password);
